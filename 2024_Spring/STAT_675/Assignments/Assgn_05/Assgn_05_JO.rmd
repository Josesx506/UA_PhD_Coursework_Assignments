...
generate_block_covariance <- function(n, p, K, Omega) {
  # Generate standard multivariate Gaussian random vector
...
data_block <- generate_block_covariance(n, p, K, Omega)
...
# These implementations should be more efficient than the generic generators by taking 
# advantage of the specific covariance structures
```
...
# Dimensionality of the sphere (can be increased for higher dimensions)
dm <- 100
...
legend("top", legend = c("Proj. Pts.", "Std. Norm."), inset=c(1,0),
       col = c("black", "red"), lwd = c(1, 2), xpd=TRUE, horiz=TRUE, bty="n")
# par(xpd=FALSE)
```
