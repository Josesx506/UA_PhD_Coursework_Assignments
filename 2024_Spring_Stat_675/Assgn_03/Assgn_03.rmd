...
# Speed test
small_bench <- microbenchmark(cumsum(test_arr_sml), cumsum1(test_arr_sml),
                              cumsum2(test_arr_sml), cumsum_cpp(test_arr_sml))
med_bench <- microbenchmark(cumsum(test_arr_med), cumsum1(test_arr_med),
                            cumsum2(test_arr_med), cumsum_cpp(test_arr_med))
big_bench <- microbenchmark(cumsum(test_arr_big), cumsum1(test_arr_big),
