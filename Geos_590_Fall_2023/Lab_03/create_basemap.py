...
pygmt.makecpt(cmap='globe',series='-3500/1700/50', continuous=True)
...
# San Francisco label
fig.plot(x=[-122.4194], y=[37.7749], style="s0.4c", pen="1.4p,black")
fig.text(x= -122.67,y=37.8, text="San Francisco", font="14p,Times-Roman,black",angle=0)
# Text labels
...
with fig.inset(position="jTR+w1.8i+o-0.2c", box="+gwhite+p1p"):
    fig.coast(region=[-130,-99,20,45],projection="M1.8i",borders="2/0.1,black",shorelines="0.1p,black",
              water="skyblue",dcw="US.CA+ggrey+p0.2p",resolution='h')
# Color Bar
