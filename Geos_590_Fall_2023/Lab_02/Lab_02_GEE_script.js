...
// Name: Joses
// Date: 10/24/2023
// Purpose of Code: Visualize change in NDVI values begore and after the 2020 Bighorn Fire in Arizona
...
// 4. Import shapefile containing polygon of Bighorn Fire parameter
var bighorn_shp = ee.FeatureCollection("projects/gee-geos590-lab2/assets/Bighorn_Parameter");
var burn_area = bighorn_shp;


// 5. Mask image collection using Bighorn_Parameter shapefile from assets folder.
// Create a function to reduce ImageCollection to the extent of
// the Bighorn burn area shapefile
...
// dates immediately before and after the Bighorn Fire.
// Set the start/end dates
var startDate = '2020-06-01';
var endDate = '2020-08-04';
...
// 7. Compute Normalized Burn Ratio (NBR) using NIR and SWIR data from before and after the Bighorn Fire.
...
var histOptions = {title: 'Pre & Post Bighorn Fire NDVI (MYD13Q1 v06)',
                   fontSize: 12,
...
// Pre-define graphical customization options
var tsOptions = {title: 'Mean NDVI within Bighorn Fire burn scar // August 2015-2023',
                 fontSize: 12,
...
Map.setCenter(-110.76, 32.42, 10)

// Add layers to map display
Map.addLayer(burn_area_ndvi_pre, ndviVis,'1 Jun NDVI');
Map.addLayer(burn_area_ndvi_post, ndviVis,'4 Aug NDVI');
Map.addLayer(ndvi_diff, ndviDiffVis,'Jun minus Aug NDVI');
Map.addLayer(dNBR.sldStyle(sld_intervals), {},'Burn Severity');

// 14. Add Bighorn_Parameter shapefile to map display window
